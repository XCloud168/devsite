    ...
    <div className="mb-5 grid grid-cols-3 gap-4">
      <div className="flex flex-col justify-between rounded-xl bg-[#2b2b2b26] px-8 py-4">
        ...
        <div className="flex items-end gap-1 space-y-4">
          <p className="text-xl font-semibold text-[#F0E4A2]">{total}</p>
          <p className="text-sm text-[#F0E4A2]">USDT</p>
        </div>
      </div>
          ...
          <Dialog open={open}>
            ...
            <DialogContent className="w-[400px] bg-black p-5">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between [&>div>button]:text-xs [&>div>button]:text-[#09CB6F]">
                  <p className="text-xs text-white/40">
                    {t("reward.walletAddress")}
                  </p>
                </div>
                <div className="flex w-full items-center gap-2 rounded-lg bg-[#1E2128] p-2">
                  <Wallet size={16} />
                ...
                <div className="flex justify-between">
                  <p className="text-xs text-white/40">{t("reward.amount")}</p>
                  <p className="text-xs text-white/40">
                    *{t("reward.rewardTip1")}
                  </p>
                </div>
      ...
      <div className="flex flex-col justify-between rounded-xl bg-[#2b2b2b26] px-8 py-5">
        <div className="flex items-center gap-1">
          <p className="text- text-xs text-white/40">{t("reward.myPoint")}</p>
          <Popover>
        ...
        <div className="flex items-end gap-1 space-y-4">
          <p className="text-xl font-semibold text-white/80">{rewardPoints}</p>
        </div>
      </div>
    </div>
  );
